...
zip -r "$PLUGIN_ZIP_NAME" "$PLUGIN_NAME_PATH" --exclude burst-payment/node_modules/\* bin burst-payment/test/\* burst-payment/.editorconfig burst-payment/.gitignore burst-payment/coverage\*.xml burst-payment/phpunit.xml burst-payment/.git/\* burst-payment/.github/\*
